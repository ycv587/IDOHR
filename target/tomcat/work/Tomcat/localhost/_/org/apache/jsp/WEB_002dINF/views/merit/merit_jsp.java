 ...
 * Generated at: 2018-04-08 00:28:55 UTC
...
public final class merit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<title>考核记录 - IDOHR</title>\r\n");
      ...
      out.write("\t\t");
      out.write("\r\n");
      out.write("\t\t<table id=\"merit-table\" class=\"table table-hover\"></table>\r\n");
      out.write("\r\n");
      out.write("\t\t");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"modal-header\">考核查询</div>\r\n");
      out.write("\t\t\t\t\t");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"sway\" id=\"sw1\" value=\"sw1\"> 查询方式1：日期查询\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"date-start\" class=\"control-label col-sm-3\">考核日期</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"datetime-local\" class=\"form-control\" id=\"date-start\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"text-align: center;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"sway\" id=\"sw2\" value=\"sw2\"> 查询方式2：分类查询\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"batch-select\" class=\"control-label col-sm-3\">考核分类</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select id=\"batch-select\" class=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"all\">全部</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"off\">已结束</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"on\">正在进行</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"start\">即将开始</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-header\">修改考核信息</div>\r\n");
      out.write("\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form\">\r\n");
      out.write("\t\t\t\t\t\t\t<form class=\"form-horizontal\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"assname-modify\" class=\"control-label col-sm-2\">考核名称</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"assname-modify\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"starttime-modify\" class=\"control-label col-sm-2\">开始时间</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"datetime-local\" class=\"form-control\" id=\"starttime-modify\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"endtime-modify\" class=\"control-label col-sm-2\">结束时间</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"datetime-local\" class=\"form-control\" id=\"endtime-modify\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t<script type=\"text/javascript\" src=\"/assets/js/merit.js\"></script>\r\n");
      out.write("\t</body>\r\n");
      out.write("\r\n");
      out.write("</html>");
