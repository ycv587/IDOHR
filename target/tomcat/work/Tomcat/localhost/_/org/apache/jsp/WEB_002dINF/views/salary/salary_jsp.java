 ...
 * Generated at: 2018-04-08 00:22:30 UTC
...
public final class salary_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<title>薪资记录 - IDOHR</title>\r\n");
      ...
      out.write("\t\t");
      out.write("\r\n");
      out.write("\t\t<table id=\"salary-table\" class=\"table table-hover\"></table>\r\n");
      out.write("\r\n");
      out.write("\t\t");
      out.write("\r\n");
      ...
      out.write("\t\t\t<i class=\"glyphicon glyphicon-search\"></i> 月度查询\r\n");
      out.write("\t\t</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t\t\t<div class=\"modal-header\">薪资月度查询</div>\r\n");
      out.write("\t\t\t\t\t");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<select id=\"year-select\" class=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label col-sm-1\" style=\"margin-left: -30px; font-weight: normal;\">年</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-sm-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select id=\"month-select\" class=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"01\">01</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"02\">02</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"03\">03</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"04\">04</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"05\">05</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"06\">06</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"07\">07</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"08\">08</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"09\">09</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"10\">10</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"11\">11</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option id=\"12\">12</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label col-sm-1\" style=\"margin-left: -30px; font-weight: normal;\">月</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t<script type=\"text/javascript\" src=\"/assets/js/salary.js\"></script>\r\n");
      out.write("\t</body>\r\n");
      out.write("\r\n");
      out.write("</html>");
