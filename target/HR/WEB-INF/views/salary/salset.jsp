			...
			<div class="form">
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<label class="control-label col-sm-1" style="margin-left: -40px; font-weight: normal;">元/小时</label>
					</div>
					...
					<div class="form-group">
						...
						<label class="control-label col-sm-1" style="margin-left: -40px; font-weight: normal;">倍</label>
