...
<html>
	...
	<body>
		...
		<%-- 配置信息显示表格 --%>
		<table id="addresult-table" class="table table-hover"></table>

		<%-- 工具按钮 --%>
		<div id="toolbar" class="btn-group pull-right">
			<%-- 查询按钮 --%>
			<button id="btn-view" type="button" class="btn btn-primary">
			<i class="glyphicon glyphicon-search"></i> 选择考核
		</button>
		</div>
		...
		<div id="model-select" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">选择考核</div>
					<%-- 窗体内容 --%>
		...
		<script type="text/javascript" src="/assets/js/addresult.js"></script>
	</body>
